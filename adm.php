    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" action="adm.php" method="get">
                <input class="form-control me-2 place_branco focus_branco text-white" style="background-color: #121516"
                       type="search" placeholder="Buscar" aria-label="Search" name="search">
